...
class LinearGGM(nn.Module):
    def __init__(
        ...
        self.gain = nn.Parameter(torch.ones(self.out_features) * float(gain_init))
        ...
        self.gamma_pr = nn.Parameter(torch.zeros(self.out_features, 1))
