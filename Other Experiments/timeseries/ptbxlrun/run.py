...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=int,
        default=0,
        help="use GGM layers in Medformer attention and FFN",
    )
    ...
    parser.add_argument(
        ...
        type=int, 
        default=0, 
        help="use XNOR-Net layers",
    )
    parser.add_argument(
        "--use_dorefa", 
        type=int, 
        default=0, 
        help="use DoReFa-Net layers"
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=0,
        help="use AdaBin layers",
    )

    args = parser.parse_args()
    args.use_ggm = bool(args.use_ggm)
    args.use_xnor = bool(args.use_xnor)
    args.use_dorefa = bool(args.use_dorefa)
    args.use_adabin = bool(args.use_adabin)
